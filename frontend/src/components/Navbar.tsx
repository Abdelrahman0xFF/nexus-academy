                    ...
                    <div className="hidden md:flex items-center gap-2 ml-4">
                        <Link to="/login">
                            <Button
                                variant="ghost"
                                size="sm"
                                className="text-small rounded-button"
                            >
                                Log In
                            </Button>
                        </Link>
                        <Link to="/signup">
                            <Button
                                size="sm"
                                className="text-small rounded-button gradient-primary border-0 text-primary-foreground hover:opacity-90 transition-opacity"
                            >
                                Sign Up
                            </Button>
                        </Link>
                        ...
                        <div className="flex flex-col gap-1">
                            ...
                            <div className="flex gap-2 mt-2 px-4">
                                ...
                                <Link to="/signup" className="flex-1">
                                    <Button
                                        size="sm"
                                        className="w-full rounded-button gradient-primary border-0 text-primary-foreground"
                                    >
                                        Sign Up
                                    </Button>
                                </Link>
