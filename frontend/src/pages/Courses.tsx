...
const allCategories = ["All", "Web Development", "Data Science", "Design", "Mobile Development", "Marketing", "Cloud Computing"];
  ...
  return (
    <MainLayout>
      <div className="container mx-auto px-4 lg:px-8 py-10">
        {/* Header */}
        <div className="mb-8">
          <h1 className="text-h1 text-foreground mb-2">Explore Courses</h1>
          <p className="text-body text-muted-foreground">Discover {courses.length}+ courses from top instructors</p>
        </div>
          ...
          <div className="flex flex-col md:flex-row gap-4">
            ...
            <div className="flex gap-2 flex-wrap">
              <select
                ...
                className="px-4 py-2.5 text-small bg-muted rounded-button border-0 outline-none focus:ring-2 focus:ring-primary/20 text-foreground"
              >
        ...
        {paginated.length > 0 ? (
          ...
          <div className="text-center py-20">
            <SlidersHorizontal size={48} className="mx-auto text-muted-foreground/30 mb-4" />
            <h3 className="text-h3 text-foreground mb-2">No courses found</h3>
            <p className="text-body text-muted-foreground">Try adjusting your filters</p>
          </div>
        )}
